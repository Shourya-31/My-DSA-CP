...
void solve()
{
    ...
    while (t--)
    {
        ...
        // auto check_pallindrome = [](string s) -> bool {
        ...
        // // Game ends when string becomes 11...1
        // // min expenditure wins or game draws for equal expenditure

        // // to make every element 1, we will check if they are already 1 or not
        // int bob_expenditure = 0;
        // int alice_expenditure = 0;
