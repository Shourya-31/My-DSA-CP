...
void solve()
{
    ...
    while (t--)
    {
        ...
        // pos = (all multiples of x) - (common multiples)

        // neg = (all multiples of y) - (common multiples)
        ...
        // count * (first + last) / 2
        int pos_sum = pos * ((n) + (n - pos + 1)) / 2;
        int neg_sum = neg * (neg + 1) / 2;
