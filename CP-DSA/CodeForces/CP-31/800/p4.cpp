...
// memory limit per testv256 megabytes
...
int main()
{
    ...
    while (t--)
    {
        ...
        // If n is divisible by 3 initially,
        // Vanya cannot force a divisible-by-3 state
        // on his own turn within 10 moves.
        if (n % 3 == 0)
        {
            cout << "Second\n"; // Vova wins
        }
        // Otherwise, Vanya can make it divisible by 3
        // in his very first move (+1 or -1).
        else
        {
            cout << "First\n"; // Vanya wins
        }
